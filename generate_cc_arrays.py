...
def generate(output: str, inputs: list[str]):
  """Create cc sources with c arrays with data from each .tflite or .bmp.
    Args:
        output: base directory for all outputs or a cc or header to generate.
        inputs: input wav, bmp or tflite files to convert. If output is a cc or
            header only one input may be specified.
  """
...
if __name__ == '__main__':
  ...
  generate(args.output, args.inputs)